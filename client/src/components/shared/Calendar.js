    ...
    return (
      <div className="mb5">
        <nav className="fixed top-0 w-100 pa3 pa4-ns tc flex justify-center items-center bg-blue shadow-1">
          <a className="link dim gray f5 f5-ns dib mh2 white b" id="left-arrow" onClick={this.handleArrowClick}> {"<"} </a>
          ...
          <a className="link tc dim gray f5 f5-ns dib mh2 white b" id="right-arrow" onClick={this.handleArrowClick}> {">"} </a>
        </nav>
      </div>
    )
  }
